...
public class OrderDinnerActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
        ...
        Utils.FetchURL.Callback callback = new Utils.FetchURL.Callback() {
            ...
            public void onComplete(Object result) {
                ...
                ArrayAdapter<String> itemsAdapter =
                        new ArrayAdapter<>(OrderDinnerActivity.this, android.R.layout.simple_list_item_1, strings);
    ...
    public void onItemClick(AdapterView<?> parent, View container, int position, long id) {
        Toast.makeText(OrderDinnerActivity.this,
